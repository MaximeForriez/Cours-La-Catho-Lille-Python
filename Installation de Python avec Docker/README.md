...
Dans ce cours, on utilise de nombreux paquets. Il suffit de taper leur nom dans le fichier `requirements.txt` **avant** de lancer la commande `docker-compose up -d`.
